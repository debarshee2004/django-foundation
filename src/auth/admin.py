...
class CustomUserAdmin(BaseUserAdmin):
    ...
    fieldsets = (
        ...
        (
            "User Preferences",
            {"fields": ("receive_marketing_emails",), "classes": ("collapse",)},
        ),
...
class UserProfileAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ("Profile Details", {"fields": ("bio", "phone_number", "avatar")}),
        (
...
class SocialAccountAdmin(admin.ModelAdmin):
    ...
    list_filter = ["provider", "is_verified", "connected_at", "last_used"]
    ...
    fieldsets = (
        ("Account Information", {"fields": ("user", "provider", "provider_id")}),
        (
            "Provider Details",
            {
                "fields": (
        ...
        ("Usage Information", {"fields": ("connected_at", "last_used")}),
        ("Additional Data", {"fields": ("extra_data",), "classes": ("collapse",)}),
    )
...
class LoginAttemptAdmin(admin.ModelAdmin):
    ...
    list_filter = ["success", "failure_reason", "attempted_at", "country"]

    search_fields = ["email_attempted", "ip_address", "user__email", "country", "city"]
    ...
    def export_security_report(self, request, queryset):
        ...
        count = queryset.count()
        self.message_user(
            request, f"Security report generated for {count} login attempts."
        )
